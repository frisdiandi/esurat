...
<body>
    <div class="container">
        ...
        <div class="letter-body">
            <div class="field">
                <strong>I. Persoalan:</strong> {{ $permintaan->perihal }}
            </div>
            <div class="field">
                <strong>II. Peranggapan:</strong>
                <p class="content">{!! $permintaan->isi_surat !!}</p>
            </div>
            <div class="field">
                <strong>III. Fakta-Fakta Yang Mempengaruhi:</strong>
                <p class="content">{{ $permintaan->keterangan ?? 'Tidak ada keterangan' }}</p>
            </div>
            <div class="field">
                <strong>IV. Analisis:</strong>
                <p class="content">{{ $permintaan->keterangan ?? 'Tidak ada keterangan' }}</p>
            </div>
            <div class="field">
