               ...
               <div class="table-responsive">
                  <table id="zero_config" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <?php
                           $jabatan= DB::table('ruangan')->find($data->id_jabatan);
                           ?>
                        <tr>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <h2>
            <hr>
            <form method="post" action="/admin/ruangan/import" enctype="multipart/form-data">
               {{ csrf_field() }}
               ...
               <div class="row mt-1">
                  <div class="col-md-6">
                     <a href="{{url('template/Template ruangan.xlsx')}}">
