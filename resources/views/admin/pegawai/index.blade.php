         ...
         <div class="d-flex no-block justify-content-end align-items-center">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><a href="/admin/pegawai">List Data Pegawai</a></li>
               </ol>
            </nav>
         </div>
      </div>
         ...
         <div class="card">
            <div class="card-body">
               <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4 class="card-title m-0"><i class="fa fa-list"></i> List Data Pegawai</h4>
                  <div>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center align-middle-custom">
                              ...
                              <img src="{{url('assets-admin')}}/assets/images/user.png" class="rounded-circle" width="50px">
                              </a>
                              @else
                              <a href="{{url('public/profil')}}/{{$data->foto}}" target="_blank">
                              <img src="{{url('public/profil')}}/{{$data->foto}}" class="rounded-circle" width="50px">
                              </a>
                              @endif
                           </td>
                           <td class="align-middle-custom">{{ $data->nip }}</td>
                           <td class="align-middle-custom">{{ $data->nama }}</td>
                           <td class="align-middle-custom">{{ $jabatan ? $jabatan->nama:'' }}</td>
